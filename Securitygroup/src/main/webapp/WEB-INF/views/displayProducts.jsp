...
<div class = "row">
   ...
   <div class = "col-sm-6 col-md-3">
      ...
      <div class = "caption">
         ...
         <p>
            <a href = "addtocart?prodid=P001" class = "btn btn-primary" role = "button">
               Add To Cart
            </a> 
            
            <a href = "addtowishlist?prodid=P002" class = "btn btn-default" role = "button">
               Add To Wish List
            </a>
         </p>
   ...
   <div class = "col-sm-6 col-md-3">
      ...
      <div class = "caption">
         ...
         <p>
            <a href = "addtocart?prodid=P002" class = "btn btn-primary" role = "button">
             Add To Cart
            </a> 
            
            <a href = "addtowishlist" class = "btn btn-default" role = "button">
           Add To Wish List
            </a>
         </p>
   ...
   <div class = "col-sm-6 col-md-3">
      ...
      <div class = "caption">
         ...
         <p>
            <a href = "addtocart?prodid='P003'" class = "btn btn-primary" role = "button">
               Add To Cart
            </a> 
   ...
   <div class = "col-sm-6 col-md-3">
      ...
      <div class = "caption">
         ...
         <p>
            <a href = "addtocart?prodid=P004" class = "btn btn-primary" role = "button">
             Add To Cart
            </a> 
